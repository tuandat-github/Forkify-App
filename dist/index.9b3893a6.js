...
})({"9P6Wm":[function(require,module,exports) {
...
const showRecipe = async function() {
    try {
        ...
        const res = await fetch("http://localhost:3000/api/v1/recipes/65d46b92a2af313eff1284a7");
        const data = await res.json();
        if (!res.ok) throw new Error(`${data.message} (${res.status})`);
        let recipe = data.data.data;
        console.log(recipe);
        // Rendering recipe
        const markup = `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","url:../img/icons.svg":"68tWU","core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ"}],"gkKU3":[function(require,module,exports) {
...
},{}],"68tWU":[function(require,module,exports) {
module.exports = require("23701df4f6fdef36").getBundleURL("cNZhx") + "icons.acb0c8c0.svg";

},{"23701df4f6fdef36":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["9P6Wm"], "9P6Wm", "parcelRequire3a11")

//# sourceMappingURL=index.9b3893a6.js.map
